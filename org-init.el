...
(if rhol-use-company
(if (not (package-installed-p 'company-auctex))
...
(setq org-capture-templates
      '(("t" "todo" entry (file (lambda () (expand-file-name (format "%s/todo.org" rhol-org-directory))))
...
;; Custom Key Bindings
(global-set-key (kbd "s-<f12>") 'org-agenda)
(global-set-key (kbd "<f7>") 'bh/set-truncate-lines)
(global-set-key (kbd "s-g") 'rhol/repo-status)
;; (global-set-key (kbd "<f8>") 'org-cycle-agenda-files)
(global-set-key (kbd "s-<f9>") 'bh/show-org-agenda)
(global-set-key (kbd "s-b") 'helm-bibtex)
(global-set-key (kbd "s-B") (lambda () (interactive) (helm-bibtex (universal-argument))))
(global-set-key (kbd "s-f") 'boxquote-insert-file)
(global-set-key (kbd "s-h") 'bh/hide-other)
(global-set-key (kbd "s-m") 'mu4e)
(global-set-key (kbd "s-n") 'bh/toggle-next-task-display)
(global-set-key (kbd "s-I") 'bh/punch-in)
(global-set-key (kbd "s-O") 'bh/punch-out)
(global-set-key (kbd "s-o") 'bh/make-org-scratch)
(global-set-key (kbd "s-r") 'boxquote-region)
(global-set-key (kbd "s-s") 'bh/switch-to-scratch)
(global-set-key (kbd "s-t") 'bh/insert-inactive-timestamp)
(global-set-key (kbd "s-T") 'bh/toggle-insert-inactive-timestamp)
(global-set-key (kbd "s-v") 'visible-mode)
(global-set-key (kbd "s-l") 'org-toggle-link-display)
(global-set-key (kbd "s-SPC") 'bh/clock-in-last-task)
...
(global-set-key (kbd "s-c") 'rhol/open-calendar)

(global-set-key (kbd "s-w") 'deft)
